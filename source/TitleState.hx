	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 12:
					deleteCoolText();
					createCoolText(['Play Flare-Sides']);
					addMoreText('Cool Mod');
				case 13:
					deleteCoolText();
					createCoolText(['Qual Sua Bandeira?']);
					addMoreText('Flamengo.');
				case 14:
					deleteCoolText();
					createCoolText(['FNF O-Sides']);
				// credTextShit.visible = true;
				case 15:
					addMoreText('Full');
				// credTextShit.text += '\nNight';
